...
**Hinweis:** Bei der Auswahl 4-20mA werden die Kommunikationsobjekte um ein KO erweitert: *Kabelbruch* 
Bei einem Stromwert < 2mA wird automatisch das KO mit dem Zustand *True* gesendet. Bei Werten >= 4mA sendet das KO den Zustand *False*
